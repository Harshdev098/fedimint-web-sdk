...
export interface InitOutput {
  ...
  readonly closure2394_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure10688_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure10727_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure11309_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure11679_externref_shim: (a: number, b: number, c: any, d: any) => void;
