...
import defineVersionedConfig from 'vitepress-versioning-plugin/dist/index.js'
    ...
    head: [
      [
        'meta',
        {
          name: 'keywords',
          content:
            'bitcoin, lightning, ecash, fedimint, typescript, wasm, react',
        },
      ],
      ...
      [
        ...
        {
          property: 'og:title',
          content: 'Fedimint Web SDK | Building Ecash into the web',
        },
      ],
      ['meta', { property: 'og:site_name', content: 'Fedimint Web SDK' }],
      [
        'meta',
        { property: 'og:image', content: 'https://web.fedimint.org/og.png' },
      ],
    ...
    themeConfig: {
      ...
      nav: [
        ...
        { text: 'Examples', link: '/examples/vite-react' },
        {
          text: 'More',
          items: [
            { text: 'Contributing', link: '/core/dev/contributing' },
            { text: 'Awesome Fedimint Web SDK', link: '/core/dev/awesome' },
            { text: 'Discussions', link: 'https://chat.fedimint.org' },
            {
              text: 'Release Notes',
      ...
      socialLinks: [
        ...
        { icon: 'discord', link: 'https://chat.fedimint.org' },
        { icon: 'twitter', link: 'https://twitter.com/fedimint' },
      ],
